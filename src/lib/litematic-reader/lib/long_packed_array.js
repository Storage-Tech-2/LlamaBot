 ...
 */
export function readLongPackedArray (array, bitsPerItem, index, tightlyPacked) {
 ...
 * @returns
 */
export function expandLongPackedArray (array, bitsPerItem, length, tightlyPacked) {
...
// # sourceMappingURL=long_packed_array.js.map
